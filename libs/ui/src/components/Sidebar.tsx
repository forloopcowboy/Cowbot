...
const NAV: {
  to: string
  key: 'nav.settings' | 'nav.holdings' | 'nav.reports' | 'nav.cowbot'
}[] = [
  { to: 'settings', key: 'nav.settings' },
  { to: 'holdings', key: 'nav.holdings' },
  { to: 'reports', key: 'nav.reports' },
  { to: 'cowbot', key: 'nav.cowbot' },
]
...
export default function Sidebar({
  ...
  return (
    <aside className="w-60 h-full shrink-0 bg-navy-900 text-slate-100 flex flex-col">
