...
# Default profile is the maintainer's personal data — keep it out of distributable
# builds. Set INVPLAN_SHIP_SEED=1 to opt in (e.g. local-dev packaging).
...
if [ "${INVPLAN_SHIP_SEED:-0}" = "1" ]; then
  ...
  DEFAULT_SRC="$ROOT/../profiles/default"
