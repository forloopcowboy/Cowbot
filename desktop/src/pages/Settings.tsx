  ...
  return (
    <PageShell
      ...
      actions={
        <>
          {savedAt && !saving && (
            <span className="text-xs text-slate-500">{timeAgo(savedAt, t)}</span>
          )}
        ...
        {advanced && (
          <div className="mt-2">
            <textarea
              ...
              spellCheck={false}
              className="w-full font-mono text-xs h-96 leading-relaxed"
            />
  ...
  return (
    <div className="px-8 py-8 max-w-5xl">
      <div className="flex items-end justify-between mb-6">
        <div>
          <div className="text-[10px] uppercase tracking-[0.2em] text-gold-500">{title}</div>
          {subtitle && <h1 className="font-serif text-2xl text-navy-900 font-semibold">{subtitle}</h1>}
        </div>
  ...
  return (
    <section className="card p-5">
      <div className="flex items-center justify-between mb-3">
        <h3 className="font-serif text-base text-navy-900 font-semibold">{title}</h3>
        {badge && (
